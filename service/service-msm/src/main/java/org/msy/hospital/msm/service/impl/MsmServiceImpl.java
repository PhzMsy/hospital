package org.msy.hospital.msm.service.impl;
...
import org.msy.hospital.msm.config.ConstantPropertiesUtils;
...
// 签名名称
        request.putQueryParameter("SignName","PhzMsy");
// 模板code: 注意，这个模板code是用阿里云短信服务管理中的模板code
        request.putQueryParameter("TemplateCode","SMS_275300183");
